...
public class SubWordFinder implements WordFinder    {
    ...
    public ArrayList<SubWord> getSubWords() {
        ...
        //look through each bucket at every word
            ...
            for(String word : bucket)   {
                ...
                for(int i = 2; i < word.length()-1; i++)    {
                    ...
                    if(inDictionary(front) && inDictionary(back))   {
                        SubWord temp = new SubWord(word, front, back);
                        subwords.add(temp);
                    }
                }
            }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The amount of subwords is: " + subwords.size());
    }
}
